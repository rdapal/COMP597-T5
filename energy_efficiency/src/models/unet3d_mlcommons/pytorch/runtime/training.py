...
from src.models.unet3d_mlcommons.pytorch.runtime.distributed_utils import get_rank, reduce_tensor, get_world_size
from src.models.unet3d_mlcommons.pytorch.runtime.inference import evaluate
from src.models.unet3d_mlcommons.pytorch.runtime.logging import mllog_event, mllog_start, mllog_end, CONSTANTS
...
def train(flags, model, train_loader, val_loader, loss_fn, score_fn, device, callbacks, is_distributed):
    ...
    for epoch in range(1, flags.epochs + 1):
        ...
        for iteration, batch in enumerate(tqdm(train_loader, disable=(rank != 0) or not flags.verbose)):
            ...
            with torch.cuda.amp.autocast(enabled=flags.amp): # deprecated?
