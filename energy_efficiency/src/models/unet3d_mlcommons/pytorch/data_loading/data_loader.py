...
from src.models.unet3d_mlcommons.pytorch.data_loading.pytorch_loader import PytVal, PytTrain
from src.models.unet3d_mlcommons.pytorch.runtime.logging import mllog_event
...
def get_data_split(path: str, num_shards: int, shard_id: int):
    ...
    eval_file = os.path.join(parent_dir, "evaluation_cases.txt")
...
def get_data_loaders(flags, num_shards, global_rank):
    ...
    train_dataset = ConcatDataset([train_dataset] * 2)
    val_dataset = ConcatDataset([val_dataset] * 2)
